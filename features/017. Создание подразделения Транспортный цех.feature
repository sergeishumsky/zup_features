...
Функционал: Создание нового подразделения Транспортный цех

Как <Роль> я хочу
<описание функционала> 
чтобы <бизнес-эффект> 

Сценарий: Создание нового подразделения Транспортный цех
...
И в поле с именем 'Наименование' я ввожу текст 'Транспортный цех'
И в поле с именем 'Аббревиатура' я ввожу текст 'ТЦ'
И в поле с именем 'НаименованиеПолное' я ввожу текст 'Транспортный цех'
...
И Я закрываю окно 'Подразделения Ромашка ООО'
Тогда открылось окно 'Подразделение (создание) *'
...
И в поле с именем 'КонтактнаяИнформацияПоле1' я ввожу текст '801712634569'
И я нажимаю на кнопку с именем 'КомандаЗаписать'
Тогда открылось окно 'Транспортный цех (Подразделение)'
И я нажимаю на кнопку с именем 'КомандаЗаписатьИЗакрыть'
И я жду закрытия окна 'Транспортный цех (Подразделение)' в течение 20 секунд
Тогда открылось окно 'Подразделения'
