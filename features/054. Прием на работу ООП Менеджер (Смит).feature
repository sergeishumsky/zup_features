...
Функционал: Прием на работу сотрудника-иностранца на позицию Менеждер/Отдел оптовых продаж на 0,5 ставки

Как <Роль> я хочу
<описание функционала> 
чтобы <бизнес-эффект> 

Сценарий: Прием на работу сотрудника-иностранца на позицию Менеждер/Отдел оптовых продаж на 0,5 ставки
