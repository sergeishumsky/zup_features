...
Функционал: Прием на работу сотрудника Начальник отдела/Отдел розничных продаж 

Как <Роль> я хочу
<описание функционала> 
чтобы <бизнес-эффект> 

Сценарий: Прием на работу сотрудника Начальник отдела/Отдел розничных продаж 
...
И в таблице "Список" я перехожу к строке:
	...
	| '4121060A077PB7'          | '00-0000003' | '4121084A036PB5'  | 'Теплова Татьяна Борисовна' |
И в таблице "Список" я выбираю текущую строку
Тогда открылось окно 'Теплова Татьяна Борисовна (Физическое лицо)'
И я нажимаю на кнопку с именем 'Работа'
Тогда открылось окно 'Теплова Татьяна Борисовна: Работа'
...
Тогда открылось окно 'Теплова Татьяна Борисовна (Сотрудник)'
...
И в поле с именем 'ДатаТК' я ввожу текст '01.01.2022'
И в поле с именем 'ДатаНачалаТК' я ввожу текст '01.01.2022'
...
И я нажимаю на кнопку с именем 'КомандаЗаписать'
Тогда открылось окно 'Прием на работу РО00-000003 от *'
И я нажимаю на кнопку с именем 'КомандаПровестиИЗакрыть'
И я жду закрытия окна 'Прием на работу РО00-000003 от *' в течение 20 секунд
Тогда открылось окно 'Теплова Татьяна Борисовна (Сотрудник)'
И я нажимаю на кнопку с именем 'КомандаЗаписать'
И я нажимаю на кнопку с именем 'КомандаЗаписатьИЗакрыть'
И я жду закрытия окна 'Теплова Татьяна Борисовна (Сотрудник)' в течение 20 секунд
Тогда открылось окно 'Теплова Татьяна Борисовна: Работа'
И Я закрываю окно 'Теплова Татьяна Борисовна: Работа'
Тогда открылось окно 'Теплова Татьяна Борисовна (Физическое лицо)'
И Я закрываю окно 'Теплова Татьяна Борисовна (Физическое лицо)'
