...
Функционал: Добавление позиции "Начальник отдела/Отдел оптовых продаж" в штатное расписание

Как <Роль> я хочу
<описание функционала> 
чтобы <бизнес-эффект> 

Сценарий: Добавление позиции "Начальник отдела/Отдел оптовых продаж" в штатное расписание
...
И я нажимаю на кнопку с именем 'ФормаВыбрать'
Тогда открылось окно 'Начальник отдела /Отдел оптовых продаж/: Позиция штатного расписания (создание) *'
