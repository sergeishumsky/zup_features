...
Функционал: Создание нового подразделения Отдел розничных продаж

Как <Роль> я хочу
<создание подрязделения Отдел розничных продаж в составе Отдела продаж> 
чтобы <бизнес-эффект> 

Сценарий: Создание нового подразделения Отдел розничных продаж
...
И в поле с именем 'Наименование' я ввожу текст 'Отдел розничных продаж'
И в поле с именем 'Аббревиатура' я ввожу текст 'ОРП'
И в поле с именем 'НаименованиеПолное' я ввожу текст 'Отдел розничных продаж'
...
Тогда открылось окно 'Отдел розничных продаж (Подразделение)'
И я нажимаю на кнопку с именем 'КомандаЗаписатьИЗакрыть'
И я жду закрытия окна 'Отдел розничных продаж (Подразделение)' в течение 20 секунд
Тогда открылось окно 'Подразделения'
