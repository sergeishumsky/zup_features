...
Функционал: Добавление позиции "Менеджер/Отдел розничных продаж" в штатное расписание

Как <Роль> я хочу
<описание функционала> 
чтобы <бизнес-эффект> 

Сценарий: Добавление позиции "Менеджер/Отдел розничных продаж" в штатное расписание
